...
#ifndef AGXFN_MATH_SQRT_H
#define AGXFN_MATH_SQRT_H
...
namespace agxFn
{
  namespace Math
  {
    ...
    */
    ...
    template <typename AutoT1, typename AutoT2>
    AGX_FORCE_INLINE AutoT1 Sqrt
    (
      const AutoT2& arg
    )
    {
      AutoT1 result;
      agxFn::Math::Sqrt(result, arg);
      return result;
    }
    ...
    */
    ...
    )
    {
      ...
      {
        agxFn::Math::Sqrt(result[i], arg[i]);
      }
    }
