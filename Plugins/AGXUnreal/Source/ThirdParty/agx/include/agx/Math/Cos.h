...
#ifndef AGXFN_MATH_COS_H
#define AGXFN_MATH_COS_H
...
namespace agxFn
{
  namespace Math
  {
    ...
    */
    ...
    {
      result = (AutoT1)std::cos(arg);
    }

    /// Generated return-value wrapper. DO NOT EDIT!
    template <typename AutoT1, typename AutoT2>
    AGX_FORCE_INLINE AutoT1 Cos
    (
      const AutoT2& arg
    )
    {
      AutoT1 result;
      agxFn::Math::Cos(result, arg);
      return result;
    }
