...
#ifndef AGXFN_MATH_SET_H
#define AGXFN_MATH_SET_H
...
namespace agxFn
{
  namespace Math
  {
    ...
    */
    ...
    template <typename AutoT1, typename AutoT2>
    AGX_FORCE_INLINE AutoT1 Set
    (
      const AutoT2& arg
    )
    {
      AutoT1 result;
      agxFn::Math::Set(result, arg);
      return result;
    }
