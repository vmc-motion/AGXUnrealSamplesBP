...
#ifndef AGXFN_MATH_DIV_H
#define AGXFN_MATH_DIV_H
...
namespace agxFn
{
  namespace Math
  {
    ...
    */
    ...
    {
      AutoT1 result;
      agxFn::Math::Div(result, arg1, arg2);
      return result;
    }
    ...
    */
    ...
    )
    {
      ...
      {
        agxFn::Math::Div(result[i], arg1[i], arg2[i]);
      }
    }
    ...
    */
    ...
    )
    {
      for (size_t i = job.range().begin(); i < job.range().end(); ++i)
      {
        agxFn::Math::Div(result[i], arg1[i], arg2);
      }
    }
    ...
    */
    ...
    )
    {
      for (size_t i = job.range().begin(); i < job.range().end(); ++i)
      {
        agxFn::Math::Div(result[i], arg1, arg2[i]);
      }
    }
