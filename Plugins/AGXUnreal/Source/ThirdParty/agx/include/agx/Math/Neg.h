...
#ifndef AGXFN_MATH_NEG_H
#define AGXFN_MATH_NEG_H
...
namespace agxFn
{
  namespace Math
  {
    ...
    */
    ...
    template <typename AutoT1, typename AutoT2>
    AGX_FORCE_INLINE AutoT1 Neg
    (
      const AutoT2& arg
    )
    {
      AutoT1 result;
      agxFn::Math::Neg(result, arg);
      return result;
    }
