...
#ifndef AGXFN_PHYSICS_GRANULARBODY_PARALLELPGS_GAUSSSEIDELITERATION_H
#define AGXFN_PHYSICS_GRANULARBODY_PARALLELPGS_GAUSSSEIDELITERATION_H
...
namespace agxFn
{
  namespace Physics
  {
    namespace GranularBody
    {
      ...
      {
        /**
        Function: Physics.GranularBody.ParallelPGS.GaussSeidelIteration
        ...
        */
        ...
        /**
        Function: Physics.GranularBody.ParallelPGS.GaussSeidelIteration
        Implementation: BandwidthTest

        \param constraint 
        \param constraintRow 
        \param solveBody 
        */
        void GaussSeidelIteration__BandwidthTest
        (
          /* Parameter list automatically generated, do not edit */
          agx::SolveContext context,
          agx::Physics::GranularBody::ContactConstraintData& constraint,
