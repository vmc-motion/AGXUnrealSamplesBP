...
#ifndef AGXFN_PHYSICS_HIERARCHICALGRID_FILLCONTACTZONES_H
#define AGXFN_PHYSICS_HIERARCHICALGRID_FILLCONTACTZONES_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.HierarchicalGrid.FillContactZones
      ...
      */
      void FillContactZones__ParticlePairContact
      (
        ...
        agxData::Array< agx::UInt32 >& sortedParticleParticleContacts
      );
      ...
      */
      void FillContactZones__ParticleGeometryContact
      (
        /* Parameter list automatically generated, do not edit */
        const agx::RangeJob& job,
        ...
        agx::Physics::HierarchicalGrid::ContactZoneData& contactZone,
        agxData::Array< agx::UInt32 >& sortedParticleGeometryContacts
      );
      ...
      \param contactZone 
      \param sortedGeometryContacts 
      */
      void FillContactZones__GeometryGeometryContact
      (
        /* Parameter list automatically generated, do not edit */
        const agx::RangeJob& job,
        ...
        agx::Physics::HierarchicalGrid::ContactZoneData& contactZone,
        agxData::Array< agx::UInt32 >& sortedGeometryContacts
      );
