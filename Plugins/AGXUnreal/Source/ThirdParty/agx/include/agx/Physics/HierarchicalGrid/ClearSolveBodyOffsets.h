...
#ifndef AGXFN_PHYSICS_HIERARCHICALGRID_CLEARSOLVEBODYOFFSETS_H
#define AGXFN_PHYSICS_HIERARCHICALGRID_CLEARSOLVEBODYOFFSETS_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.HierarchicalGrid.ClearSolveBodyOffsets
      Implementation: (default)

      \param solveBodyManager 
      */
      void ClearSolveBodyOffsets
      (
