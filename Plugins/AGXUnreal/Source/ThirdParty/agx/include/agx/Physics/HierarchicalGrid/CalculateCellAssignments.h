...
#ifndef AGXFN_PHYSICS_HIERARCHICALGRID_CALCULATECELLASSIGNMENTS_H
#define AGXFN_PHYSICS_HIERARCHICALGRID_CALCULATECELLASSIGNMENTS_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.HierarchicalGrid.CalculateCellAssignments
      ...
      */
      void CalculateCellAssignments__Particle
      (
        ...
        agxData::Array< agx::UInt32 >& particlesWithMissingTargetCell
      );
      ...
      \param disabledGeometries 
      \param zeroSizedGeometries 
      */
      void CalculateCellAssignments__Geometry
      (
        /* Parameter list automatically generated, do not edit */
        const agx::RangeJob& job,
        ...
        agx::Physics::HierarchicalGrid::GridTierData& gridTier,
        agx::Physics::HierarchicalGrid::CellData& cell,
        agxData::Array< agx::UInt32 >& geometriesWithMissingTargetCell,
        agxData::Array< agx::UInt32 >& infiniteGeometries,
        agxData::Array< agx::UInt32 >& disabledGeometries,
        agxData::Array< agx::UInt32 >& zeroSizedGeometries
      );
