...
#ifndef AGXFN_PHYSICS_GRANULARBODY_PARALLELPGS_CALCULATERHS32_H
#define AGXFN_PHYSICS_GRANULARBODY_PARALLELPGS_CALCULATERHS32_H
...
namespace agx { namespace Physics { namespace GranularBody { namespace ParallelPGS { } } } }
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      namespace ParallelPGS
      {
        /**
        Function: Physics.GranularBody.ParallelPGS.CalculateRHS32
        ...
        \param contactMode 
        */
        void CalculateRHS32__GranularGranularContact
        (
        ...
        \param contactMode 
        */
        void CalculateRHS32__GranularGeometryContact
        (
          /* Parameter list automatically generated, do not edit */
          agx::SolveContext context,
