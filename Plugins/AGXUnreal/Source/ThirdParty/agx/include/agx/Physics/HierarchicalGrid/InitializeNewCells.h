...
#ifndef AGXFN_PHYSICS_HIERARCHICALGRID_INITIALIZENEWCELLS_H
#define AGXFN_PHYSICS_HIERARCHICALGRID_INITIALIZENEWCELLS_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.HierarchicalGrid.InitializeNewCells
      ...
      */
      void InitializeNewCells
      (
        /* Parameter list automatically generated, do not edit */
        const agx::RangeJob& job,
        const agxData::Array< agx::UInt32 >& newCells,
