...
#ifndef AGXFN_PHYSICS_PARTICLESYSTEM_GENERATEPARTICLEPAIRCONTACTS_H
#define AGXFN_PHYSICS_PARTICLESYSTEM_GENERATEPARTICLEPAIRCONTACTS_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.ParticleSystem.GenerateParticlePairContacts
      ...
      */
      void GenerateParticlePairContacts
      (
