...
#ifndef AGXFN_PHYSICS_RIGIDBODY_APPLYUNIFORMGRAVITY_H
#define AGXFN_PHYSICS_RIGIDBODY_APPLYUNIFORMGRAVITY_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.RigidBody.ApplyUniformGravity
