...
#ifndef AGXFN_PHYSICS_RIGIDBODY_SOLVER_UPDATEDIRECTSOLVERBOUNDS_H
#define AGXFN_PHYSICS_RIGIDBODY_SOLVER_UPDATEDIRECTSOLVERBOUNDS_H
...
namespace agxFn
{
  namespace Physics
  {
    namespace RigidBody
    {
      ...
      {
        /**
        Function: Physics.RigidBody.Solver.UpdateDirectSolverBounds
