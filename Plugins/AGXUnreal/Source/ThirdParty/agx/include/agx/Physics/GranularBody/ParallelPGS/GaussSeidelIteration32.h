...
#ifndef AGXFN_PHYSICS_GRANULARBODY_PARALLELPGS_GAUSSSEIDELITERATION32_H
#define AGXFN_PHYSICS_GRANULARBODY_PARALLELPGS_GAUSSSEIDELITERATION32_H
...
namespace agxFn
{
  namespace Physics
  {
    namespace GranularBody
    {
      ...
      {
        /**
        Function: Physics.GranularBody.ParallelPGS.GaussSeidelIteration32
