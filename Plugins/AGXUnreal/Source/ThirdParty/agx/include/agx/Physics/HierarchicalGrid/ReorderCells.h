...
#ifndef AGXFN_PHYSICS_HIERARCHICALGRID_REORDERCELLS_H
#define AGXFN_PHYSICS_HIERARCHICALGRID_REORDERCELLS_H
...
#include <agx/Physics/HierarchicalGrid/CellReordering.h>
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.HierarchicalGrid.ReorderCells
      ...
      */
      ...
      (
        ...
        agx::CellReordering* cellReordering
      );
