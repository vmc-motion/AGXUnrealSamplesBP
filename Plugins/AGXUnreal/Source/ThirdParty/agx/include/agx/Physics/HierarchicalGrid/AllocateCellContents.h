...
#ifndef AGXFN_PHYSICS_HIERARCHICALGRID_ALLOCATECELLCONTENTS_H
#define AGXFN_PHYSICS_HIERARCHICALGRID_ALLOCATECELLCONTENTS_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.HierarchicalGrid.AllocateCellContents
      Implementation: (default)

      \param sortedCells 
      \param cell 
      \param infiniteGeometries 
      \param collisionObjectStorage 
      */
      void AllocateCellContents
      (
        ...
        agxData::EntityStorage* collisionObjectStorage
      );
