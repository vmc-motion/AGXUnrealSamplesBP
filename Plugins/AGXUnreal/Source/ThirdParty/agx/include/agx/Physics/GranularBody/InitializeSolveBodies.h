...
#ifndef AGXFN_PHYSICS_GRANULARBODY_INITIALIZESOLVEBODIES_H
#define AGXFN_PHYSICS_GRANULARBODY_INITIALIZESOLVEBODIES_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.GranularBody.InitializeSolveBodies
      ...
      */
      ...
      \param thetaSteppingParameter 
      */
      void InitializeSolveBodies__SolveBody32
      (
        /* Parameter list automatically generated, do not edit */
        const agx::RangeJob& job,
        agx::Physics::GranularBodyData& particle,
