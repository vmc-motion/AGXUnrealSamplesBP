...
#ifndef AGXFN_PHYSICS_PARTICLESYSTEM_GAUSSSEIDELCONTACTSOLVER_CALCULATEGMINV_H
#define AGXFN_PHYSICS_PARTICLESYSTEM_GAUSSSEIDELCONTACTSOLVER_CALCULATEGMINV_H
...
namespace agxFn
{
  namespace Physics
  {
    namespace ParticleSystem
    {
      ...
      {
        /**
        Function: Physics.ParticleSystem.GaussSeidelContactSolver.CalculateGMInv
        ...
        \param particle 
        */
        void CalculateGMInv__ParticlePairContact
        (
        ...
        \param particle 
        */
        void CalculateGMInv__ParticleGeometryContact
        (
          /* Parameter list automatically generated, do not edit */
          const agx::RangeJob& job,
