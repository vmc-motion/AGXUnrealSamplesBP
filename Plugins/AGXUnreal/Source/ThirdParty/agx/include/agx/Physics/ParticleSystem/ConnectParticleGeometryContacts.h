...
#ifndef AGXFN_PHYSICS_PARTICLESYSTEM_CONNECTPARTICLEGEOMETRYCONTACTS_H
#define AGXFN_PHYSICS_PARTICLESYSTEM_CONNECTPARTICLEGEOMETRYCONTACTS_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.ParticleSystem.ConnectParticleGeometryContacts
      ...
      */
      void ConnectParticleGeometryContacts
      (
