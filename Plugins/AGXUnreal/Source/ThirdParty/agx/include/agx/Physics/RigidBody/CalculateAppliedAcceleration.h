...
#ifndef AGXFN_PHYSICS_RIGIDBODY_CALCULATEAPPLIEDACCELERATION_H
#define AGXFN_PHYSICS_RIGIDBODY_CALCULATEAPPLIEDACCELERATION_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.RigidBody.CalculateAppliedAcceleration
      ...
      */
      void CalculateAppliedAcceleration
      (
