...
#ifndef AGXFN_PHYSICS_GRANULARBODY_INTEGRATEVELOCITY_H
#define AGXFN_PHYSICS_GRANULARBODY_INTEGRATEVELOCITY_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.GranularBody.IntegrateVelocity
