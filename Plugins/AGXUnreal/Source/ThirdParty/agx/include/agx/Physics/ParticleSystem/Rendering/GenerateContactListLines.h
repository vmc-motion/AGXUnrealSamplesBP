...
#ifndef AGXFN_PHYSICS_PARTICLESYSTEM_RENDERING_GENERATECONTACTLISTLINES_H
#define AGXFN_PHYSICS_PARTICLESYSTEM_RENDERING_GENERATECONTACTLISTLINES_H
...
namespace agxFn
{
  namespace Physics
  {
    namespace ParticleSystem
    {
      ...
      {
        /**
        Function: Physics.ParticleSystem.Rendering.GenerateContactListLines
        ...
        */
        ...
        (
          ...
          agxData::Array< agx::Line32 >& lines,
