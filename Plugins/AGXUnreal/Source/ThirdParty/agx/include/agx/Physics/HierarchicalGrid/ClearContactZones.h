...
#ifndef AGXFN_PHYSICS_HIERARCHICALGRID_CLEARCONTACTZONES_H
#define AGXFN_PHYSICS_HIERARCHICALGRID_CLEARCONTACTZONES_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.HierarchicalGrid.ClearContactZones
      Implementation: (default)

      \param job The range job specifying what part of the data set to process
      \param contactZone 
      */
      void ClearContactZones
      (
