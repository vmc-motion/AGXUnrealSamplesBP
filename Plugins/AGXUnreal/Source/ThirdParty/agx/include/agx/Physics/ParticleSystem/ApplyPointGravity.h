...
#ifndef AGXFN_PHYSICS_PARTICLESYSTEM_APPLYPOINTGRAVITY_H
#define AGXFN_PHYSICS_PARTICLESYSTEM_APPLYPOINTGRAVITY_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.ParticleSystem.ApplyPointGravity
