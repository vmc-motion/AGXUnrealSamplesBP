...
#ifndef AGXFN_PHYSICS_GRANULARBODY_SETANGULARVELOCITY_H
#define AGXFN_PHYSICS_GRANULARBODY_SETANGULARVELOCITY_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.GranularBody.SetAngularVelocity
