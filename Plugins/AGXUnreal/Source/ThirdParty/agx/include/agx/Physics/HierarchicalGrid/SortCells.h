...
#ifndef AGXFN_PHYSICS_HIERARCHICALGRID_SORTCELLS_H
#define AGXFN_PHYSICS_HIERARCHICALGRID_SORTCELLS_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.HierarchicalGrid.SortCells
      ...
      */
      ...
      (
        /* Parameter list automatically generated, do not edit */
        agxData::Array< agx::Physics::HierarchicalGrid::Cell2DPtr >& rootCells,
        agx::Physics::HierarchicalGrid::Cell2DData& cell,
        agxData::Array< agx::UInt32 >& sortedCells,
        agxData::Buffer* sortedCellsBuffer
      );
