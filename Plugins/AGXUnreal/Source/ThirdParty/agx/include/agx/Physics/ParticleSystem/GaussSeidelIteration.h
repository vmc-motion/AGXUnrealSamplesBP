...
#ifndef AGXFN_PHYSICS_PARTICLESYSTEM_GAUSSSEIDELITERATION_H
#define AGXFN_PHYSICS_PARTICLESYSTEM_GAUSSSEIDELITERATION_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.ParticleSystem.GaussSeidelIteration
      ...
      \param timeStep 
      */
      void GaussSeidelIteration__ParticlePairContact
      (
      ...
      \param timeStep 
      */
      void GaussSeidelIteration__ParticleGeometryContact
      (
        /* Parameter list automatically generated, do not edit */
        agx::SolveContext context,
