...
#ifndef AGXFN_PHYSICS_RIGIDBODY_SOLVER_SYNCHRONIZEDIRECTSOLVER_H
#define AGXFN_PHYSICS_RIGIDBODY_SOLVER_SYNCHRONIZEDIRECTSOLVER_H
...
namespace agxFn
{
  namespace Physics
  {
    namespace RigidBody
    {
      ...
      {
        /**
        Function: Physics.RigidBody.Solver.SynchronizeDirectSolver
        ...
        \param rigidBody 
        \param particleBodyContactConstraint_G 
        \param particleBodyContactConstraint_Row_lambda 
        \param granularGeometryJacobianStorage 
        \param granularBodyContactConstraint_rowIndex 
        \param granularBodyContactConstraint_jacobianIndex 
        \param granularBodyContactConstraint_Row_lambda 
        \param contactMode 
        */
        void SynchronizeDirectSolver
        (
          ...
          const agxData::Array< agx::ParticleBodyContactJacobian >& particleBodyContactConstraint_G,
          const agxData::Array< agx::Real >& particleBodyContactConstraint_Row_lambda,
          const agxData::Array< agx::Jacobian6DOFElement >& granularGeometryJacobianStorage,
          const agxData::Array< agx::UInt32 >& granularBodyContactConstraint_rowIndex,
          const agxData::Array< agx::UInt32 >& granularBodyContactConstraint_jacobianIndex,
          const agxData::Array< agx::Real >& granularBodyContactConstraint_Row_lambda,
