...
#ifndef AGXFN_PHYSICS_GRANULARBODY_INTEGRATEVELOCITIES_H
#define AGXFN_PHYSICS_GRANULARBODY_INTEGRATEVELOCITIES_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.GranularBody.IntegrateVelocities
      ...
      \param thetaSteppingParameter 
      */
      void IntegrateVelocities__SolveBody
      (
        ...
        const agx::Real& thetaSteppingParameter
      );
      ...
      \param thetaSteppingParameter 
      */
      void IntegrateVelocities__SolveBody32
      (
        /* Parameter list automatically generated, do not edit */
        const agx::RangeJob& job,
        agx::Physics::GranularBodyData& particle,
