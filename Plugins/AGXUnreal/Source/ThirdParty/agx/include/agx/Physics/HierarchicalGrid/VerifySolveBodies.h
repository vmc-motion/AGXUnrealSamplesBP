...
#ifndef AGXFN_PHYSICS_HIERARCHICALGRID_VERIFYSOLVEBODIES_H
#define AGXFN_PHYSICS_HIERARCHICALGRID_VERIFYSOLVEBODIES_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.HierarchicalGrid.VerifySolveBodies
      Implementation: (default)

      \param particle 
      */
      void VerifySolveBodies
      (
