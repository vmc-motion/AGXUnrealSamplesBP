...
#ifndef AGXFN_PHYSICS_GEOMETRY_SYNCHRONIZEGEOMETRYBOUNDS_H
#define AGXFN_PHYSICS_GEOMETRY_SYNCHRONIZEGEOMETRYBOUNDS_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.Geometry.SynchronizeGeometryBounds
