...
#ifndef AGXFN_PHYSICS_HIERARCHICALGRID_COUNTCELLOCCUPANCY_H
#define AGXFN_PHYSICS_HIERARCHICALGRID_COUNTCELLOCCUPANCY_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.HierarchicalGrid.CountCellOccupancy
      Implementation: Geometries

      \param geometry 
      \param cell 
      */
      void CountCellOccupancy__Geometries
      (
      ...
      \param cell 
      */
      void CountCellOccupancy__Particles
      (
        /* Parameter list automatically generated, do not edit */
