...
#ifndef AGXFN_PHYSICS_HIERARCHICALGRID_GENERATESOLVEBODIES_H
#define AGXFN_PHYSICS_HIERARCHICALGRID_GENERATESOLVEBODIES_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.HierarchicalGrid.GenerateSolveBodies
