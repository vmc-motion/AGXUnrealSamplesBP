...
#ifndef AGXFN_PHYSICS_HIERARCHICALGRID_INSERTGEOMETRIES_H
#define AGXFN_PHYSICS_HIERARCHICALGRID_INSERTGEOMETRIES_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.HierarchicalGrid.InsertGeometries
