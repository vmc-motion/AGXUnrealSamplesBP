...
#ifndef AGXFN_PHYSICS_RIGIDBODY_MATCHCONTACTSTATES_H
#define AGXFN_PHYSICS_RIGIDBODY_MATCHCONTACTSTATES_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.RigidBody.MatchContactStates
