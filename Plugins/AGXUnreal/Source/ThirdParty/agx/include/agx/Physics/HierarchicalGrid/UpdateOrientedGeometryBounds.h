...
#ifndef AGXFN_PHYSICS_HIERARCHICALGRID_UPDATEORIENTEDGEOMETRYBOUNDS_H
#define AGXFN_PHYSICS_HIERARCHICALGRID_UPDATEORIENTEDGEOMETRYBOUNDS_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.HierarchicalGrid.UpdateOrientedGeometryBounds
      ...
      \param geometry 
      */
      void UpdateOrientedGeometryBounds
      (
