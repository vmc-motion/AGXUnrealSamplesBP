...
#ifndef AGXFN_PHYSICS_HIERARCHICALGRID_PRINTCONTACTZONESTATISTICS_H
#define AGXFN_PHYSICS_HIERARCHICALGRID_PRINTCONTACTZONESTATISTICS_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.HierarchicalGrid.PrintContactZoneStatistics
      Implementation: (default)

      \param contactZone 
      \param contactZoneDependency 
      */
      void PrintContactZoneStatistics
      (
