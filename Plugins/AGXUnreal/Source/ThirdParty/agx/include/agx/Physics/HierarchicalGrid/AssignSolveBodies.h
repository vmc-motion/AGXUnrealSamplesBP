...
#ifndef AGXFN_PHYSICS_HIERARCHICALGRID_ASSIGNSOLVEBODIES_H
#define AGXFN_PHYSICS_HIERARCHICALGRID_ASSIGNSOLVEBODIES_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.HierarchicalGrid.AssignSolveBodies
      ...
      */
      ...
      /**
      Function: Physics.HierarchicalGrid.AssignSolveBodies
      Implementation: NoReordering

      \param job The range job specifying what part of the data set to process
      \param particle 
      */
      void AssignSolveBodies__NoReordering
      (
        /* Parameter list automatically generated, do not edit */
        const agx::RangeJob& job,
        agx::Physics::ParticleData& particle
      ...
      /**
      Function: Physics.HierarchicalGrid.AssignSolveBodies
      Implementation: RandomShuffle

      \param particle 
      */
      void AssignSolveBodies__RandomShuffle
      (
        /* Parameter list automatically generated, do not edit */
        agx::Physics::ParticleData& particle
      );
