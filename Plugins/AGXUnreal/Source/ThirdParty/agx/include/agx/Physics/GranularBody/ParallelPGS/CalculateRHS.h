...
#ifndef AGXFN_PHYSICS_GRANULARBODY_PARALLELPGS_CALCULATERHS_H
#define AGXFN_PHYSICS_GRANULARBODY_PARALLELPGS_CALCULATERHS_H
...
namespace agxFn
{
  namespace Physics
  {
    namespace GranularBody
    {
      ...
      {
        /**
        Function: Physics.GranularBody.ParallelPGS.CalculateRHS
