...
#ifndef AGXFN_PHYSICS_PARTICLESYSTEM_APPLYUNIFORMGRAVITY_H
#define AGXFN_PHYSICS_PARTICLESYSTEM_APPLYUNIFORMGRAVITY_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.ParticleSystem.ApplyUniformGravity
