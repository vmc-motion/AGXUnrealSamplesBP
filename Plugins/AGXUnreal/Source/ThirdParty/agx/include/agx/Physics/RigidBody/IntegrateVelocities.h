...
#ifndef AGXFN_PHYSICS_RIGIDBODY_INTEGRATEVELOCITIES_H
#define AGXFN_PHYSICS_RIGIDBODY_INTEGRATEVELOCITIES_H
...
namespace agxFn
{
  namespace Physics
  {
    ...
    {
      /**
      Function: Physics.RigidBody.IntegrateVelocities
